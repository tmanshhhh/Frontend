                ...
                <Info>
                    ...
                    Маньшина Таисия</span>, мне 20 лет. Больше всего в жизни я люблю <span
                        style={{
                            color: "#806a6a",
                            fontWeight: "bold"
                        }}>спорт, активный отдых, машины и путешествия</span>.
                    </div>
                    <br/>
                    Я живу во Владивостоке, городе, который дарит море возможностей реализовывать мои интересы. Учусь я
                    в Дальневосточном федеральном университете на специальности <span
                    style={{color: "#806a6a", fontWeight: "bold"}}>Прикладная математика и информатика</span>.

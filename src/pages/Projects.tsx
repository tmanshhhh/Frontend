...
import { Container } from "@ styles/ProjectsStyle/PageContainer.tsx";
...
import { LocalProjectStore } from "@/store/LocalProjectStore.ts";
...
export const ProjectComponent: React.FC = () => {
    ...
    const { projects, addProject, deleteProject: deleteProject } = LocalProjectStore();
